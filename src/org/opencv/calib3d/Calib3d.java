 ...
 */
    public static int estimateAffine3D(Mat _from, Mat _to, Mat _out, Mat _inliers)
    {
        ...
        int retVal = estimateAffine3D_1(_from.nativeObj, _to.nativeObj, _out.nativeObj, _inliers.nativeObj);
 ...
 */
    ...
    //
    // C++:  bool solvePnP(vector_Point3f objectPoints, vector_Point2f imagePoints, Mat cameraMatrix, vector_double distCoeffs, Mat& rvec, Mat& tvec, bool useExtrinsicGuess = false, int flags = 0)
    //
 ...
 */
    ...
    //
    // C++:  void solvePnPRansac(vector_Point3f objectPoints, vector_Point2f imagePoints, Mat cameraMatrix, vector_double distCoeffs, Mat& rvec, Mat& tvec, bool useExtrinsicGuess = false, int iterationsCount = 100, float reprojectionError = 8.0, int minInliersCount = 100, Mat& inliers = Mat(), int flags = 0)
    //
 ...
 * @param validPixROI1 a validPixROI1
 * @param validPixROI2 a validPixROI2
 *
 ...
 */
    ...
    private static native int estimateAffine3D_1(long _from_nativeObj, long _to_nativeObj, long _out_nativeObj, long _inliers_nativeObj);
