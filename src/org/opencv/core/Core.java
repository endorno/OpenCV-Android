 ...
 *
 * <p>The function returns the number of non-zero elements in <code>mtx</code> :</p>
 *
 * <p><em>sum(by: I: mtx(I) != 0) 1</em></p>
 *
 * @param src a src
 *
 ...
 *
 * <p>In case of the <code>DECOMP_LU</code> method, the function returns the
 * <code>src</code> determinant (<code>src</code> must be square). If it is 0,
 * the matrix is not inverted and <code>dst</code> is filled with zeros.</p>
 *
 ...
 * the centers of <code>clusterCount</code> clusters and groups the input
 ...
 * convolution (pass <code>conj=false</code>) or correlation (pass
 * <code>conj=false</code>) of two arrays rapidly. When the arrays are complex,
 ...
 * as the type of created destination matrix. See the <code>rtype</code>
 ...
 * <code>p</code> :</p>
 *
 * <p><em>dst(I) = src(I)^p if p is integer; |src(I)|^p otherwise</em></p>
 *
 ...
 *
 * <p>For some values of <code>p</code>, such as integer values, 0.5 and -0.5,
 ...
 *
 * <p>The function <code>randn</code> fills the matrix <code>mtx</code> with
 ...
 * <code>mtx</code> with uniformly-distributed random numbers from the specified
 * range:</p>
 *
 * <p><em>low _c <= mtx(I)_c < high _c</em></p>
 *
 * @param dst a dst
 ...
 *
 * <p><em>dst(i,j)= value if i=j; 0 otherwise</em></p>
 *
 ...
 * function the number of arrays must match <code>mtx.channels()</code>. The
 ...
 * <code>dst</code> :</p>
 *
 * <p><em>dst(I) = mtx * src(I)</em></p>
 *
 * <p>(when <code>mtx.cols=src.channels()</code>), or</p>
 *
 * <p><em>dst(I) = mtx * [ src(I); 1]</em></p>
 *
 * <p>(when <code>mtx.cols=src.channels()+1</code>)</p>
 *
 ...
 * <code>M x N</code> or <code>M x (N+1)</code> matrix <code>mtx</code> to
 ...
 * <code>mtx.cols</code> or <code>mtx.cols-1</code>.
 * @param dst Destination array of the same size and depth as <code>src</code>.
 * It has as many channels as <code>mtx.rows</code>.
 * @param m a m
 *
